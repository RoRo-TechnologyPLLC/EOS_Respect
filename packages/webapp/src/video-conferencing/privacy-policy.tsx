...
export const ZoomPrivacyPolicy = () => {
    return (
        <Container className="space-y-2.5">
            <Text>
                Your Zoom account will be used to schedule EOS Respect election
                meetings on your behalf for members participating in your EOS Respect
            ...
            <Text>
                ...
                EOS Respect is your Zoom OAuth token, and that is stored only in your
                local web browser.
            </Text>
            <Text>
                Whenever you request that an election meeting be scheduled by
                EOS Respect on your behalf, that OAuth token is sent, ephemerally, to
            ...
            <Text>
                ...
                browser's cache or settings is sufficient to deny the EOS Respect
